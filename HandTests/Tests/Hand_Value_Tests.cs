...
namespace HandTests.Tests
{
    ...
    public class When_Hand_Contains_High_Card : SpecificationContext
    {
        ...
        private IList<Card> _higherCardHand;
        private double _higherCardHandValue;
        ...
        public override void CreateContext()
        {
            ...
            _higherCardHand = new List<Card>{new Card(CardFigure.Two,CardColor.Hearts),
                                    new Card(CardFigure.Nine,CardColor.Clubs),
                                    new Card(CardFigure.Three, CardColor.Hearts),
                                    new Card(CardFigure.Six, CardColor.Clubs),
                                    new Card(CardFigure.Four, CardColor.Spades)};
            ...
            _higherCardHandValue = new Hand(_higherCardHand).Value;
